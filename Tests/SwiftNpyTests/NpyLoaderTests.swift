...
class NpyLoaderTests: XCTestCase {
    ...
    func testLoadStrings() {
        do {
            let npy: Npy = try! Npy(data: s_1)
            XCTAssertEqual(npy.shape, [3])
            let elements: [String] = npy.elements()
            XCTAssertEqual(elements, ["", "", ""])
        }
        do {
            let npy: Npy = try! Npy(data: s_2)
            XCTAssertEqual(npy.shape, [3])
            let elements: [String] = npy.elements()
            XCTAssertEqual(elements, ["a", "b", "c"])
        }
        do {
            let npy: Npy = try! Npy(data: s_3)
            XCTAssertEqual(npy.shape, [3])
            let elements: [String] = npy.elements()
            XCTAssertEqual(elements, ["a", "b", "ccccccc"])
        }
        do {
            let npy: Npy = try! Npy(data: s_4)
            XCTAssertEqual(npy.shape, [3,2])
            let elements: [String] = npy.elements()
            XCTAssertEqual(elements, ["a", "b", "c", "d", "e", "f"])
        }
    }
    ...
    static var allTests = [
        ...
        ("testLoadStrings", testLoadStrings),
...
// elements = ["", "", ""], shape = [3]
let s_1 = Data(bytes: [
    0x93, 0x4E, 0x55, 0x4D, 0x50, 0x59, 0x01, 0x00, 0x3A, 0x00, 0x7B, 0x20, 0x27, 0x64, 0x65, 0x73, 
    0x63, 0x72, 0x27, 0x3A, 0x20, 0x27, 0x7C, 0x53, 0x30, 0x27, 0x2C, 0x20, 0x27, 0x66, 0x6F, 0x72, 
    0x74, 0x72, 0x61, 0x6E, 0x5F, 0x6F, 0x72, 0x64, 0x65, 0x72, 0x27, 0x3A, 0x20, 0x46, 0x61, 0x6C, 
    0x73, 0x65, 0x2C, 0x20, 0x27, 0x73, 0x68, 0x61, 0x70, 0x65, 0x27, 0x3A, 0x20, 0x28, 0x33, 0x2C, 
    0x29, 0x2C, 0x20, 0x7D
])

// elements = ["a", "b", "c"], shape = [3]
let s_2 = Data(bytes: [
    0x93, 0x4E, 0x55, 0x4D, 0x50, 0x59, 0x01, 0x00, 0x3A, 0x00, 0x7B, 0x20, 0x27, 0x64, 0x65, 0x73, 
    0x63, 0x72, 0x27, 0x3A, 0x20, 0x27, 0x7C, 0x53, 0x31, 0x27, 0x2C, 0x20, 0x27, 0x66, 0x6F, 0x72, 
    0x74, 0x72, 0x61, 0x6E, 0x5F, 0x6F, 0x72, 0x64, 0x65, 0x72, 0x27, 0x3A, 0x20, 0x46, 0x61, 0x6C, 
    0x73, 0x65, 0x2C, 0x20, 0x27, 0x73, 0x68, 0x61, 0x70, 0x65, 0x27, 0x3A, 0x20, 0x28, 0x33, 0x2C, 
    0x29, 0x2C, 0x20, 0x7D, 0x61, 0x62, 0x63
])

// elements = ["a", "b", "ccccccc"], shape = [3]
let s_3 = Data(bytes: [
    0x93, 0x4E, 0x55, 0x4D, 0x50, 0x59, 0x01, 0x00, 0x3A, 0x00, 0x7B, 0x20, 0x27, 0x64, 0x65, 0x73,
    0x63, 0x72, 0x27, 0x3A, 0x20, 0x27, 0x7C, 0x53, 0x37, 0x27, 0x2C, 0x20, 0x27, 0x66, 0x6F, 0x72, 
    0x74, 0x72, 0x61, 0x6E, 0x5F, 0x6F, 0x72, 0x64, 0x65, 0x72, 0x27, 0x3A, 0x20, 0x46, 0x61, 0x6C, 
    0x73, 0x65, 0x2C, 0x20, 0x27, 0x73, 0x68, 0x61, 0x70, 0x65, 0x27, 0x3A, 0x20, 0x28, 0x33, 0x2C, 
    0x29, 0x2C, 0x20, 0x7D, 0x61, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x62, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x63, 0x63, 0x63, 0x63, 0x63, 0x63, 0x63
])

// elements = ["a", "b", "c", "d", "e", "f"], shape = [3,2]
let s_4 = Data(bytes:[
    0x93, 0x4E, 0x55, 0x4D, 0x50, 0x59, 0x01, 0x00, 0x3C, 0x00, 0x7B, 0x20, 0x27, 0x64, 0x65, 0x73, 
    0x63, 0x72, 0x27, 0x3A, 0x20, 0x27, 0x7C, 0x53, 0x31, 0x27, 0x2C, 0x20, 0x27, 0x66, 0x6F, 0x72, 
    0x74, 0x72, 0x61, 0x6E, 0x5F, 0x6F, 0x72, 0x64, 0x65, 0x72, 0x27, 0x3A, 0x20, 0x46, 0x61, 0x6C, 
    0x73, 0x65, 0x2C, 0x20, 0x27, 0x73, 0x68, 0x61, 0x70, 0x65, 0x27, 0x3A, 0x20, 0x28, 0x33, 0x2C, 
    0x20, 0x32, 0x29, 0x2C, 0x20, 0x7D, 0x61, 0x62, 0x63, 0x64, 0x65, 0x66
])